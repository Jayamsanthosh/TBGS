-- =============================================================
-- [VRequest].[GET_ARREARS_REQUEST]  (Dual-mode)
--   * @ARREAR_REQUEST_REF_NO given -> single-record detail (entry screen).
--   * ref blank                     -> Arrears list for the Report Dashboard,
--                                     same aliases/filters/paging as
--                                     GET_REQUEST_LIST_BY_TYPE
--                                     ('Arrears Request').
-- =============================================================
CREATE OR ALTER PROCEDURE [VRequest].[GET_ARREARS_REQUEST]
(
    @ARREAR_REQUEST_REF_NO VARCHAR(50) = NULL,
...
BEGIN
    ...
    IF LTRIM(RTRIM(ISNULL(@ARREAR_REQUEST_REF_NO, ''))) <> ''
    BEGIN
        SELECT
            [SNO],
