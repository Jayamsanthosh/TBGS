...
export const getAllPriceTypeService = async () => {
  const pool = getPool();
...
export const getPriceTypeByIdService = async (id: number) => {
  const pool = getPool();
  if (!pool) throw new Error("Database not connected");
...
export const savePriceTypeService = async (data: PriceTypeData) => {
  const pool = getPool();
  if (!pool) throw new Error("Database not connected");
...
export const updatePriceTypeService = async (data: PriceTypeData) => {
  const pool = getPool();
  if (!pool) throw new Error("Database not connected");
...
export const deletePriceTypeService = async (
  id: number,
  user: string,
  role: string,
  macAddress: string
