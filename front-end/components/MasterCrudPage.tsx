...
export default function MasterCrudPage({ title, description, idPrefix, domain, fields, initialData, columns, customAddUrl, customEditUrl, customStoreOverrides, onPrint, onBeforeEdit, onViewData, statusOptions, onStatusFilterChange, onSaveValidate, enableViewDetails }: MasterPageProps) {
