                    ...
                    <table className="w-full text-sm border-collapse">
                      <thead>
                        <tr className="bg-muted/50 text-left text-[11px] uppercase tracking-wide text-muted-foreground">
                          ...
                          <th className="p-2 font-semibold w-[15%]">Govt Rate</th>
                          <th className="p-2 font-semibold w-[15%]">Actual Amt</th>
                      ...
                      <tbody>
                        {dtls.map((row) => (
                          <tr key={row.key} className="border-t hover:bg-muted/30 transition-colors">
                            ...
                            <td className="p-1">
                              <Input type="number" min="0" step="any" value={row.GOVT_RATE} onChange={(e) => updateDtl(row.key, "GOVT_RATE", clampNonNegative(e.target.value))} className="h-8 text-xs w-28" />
                            </td>
                            <td className="p-1">
                              <Input type="number" min="0" step="any" value={row.ACTUAL_AMOUNT} onChange={(e) => updateDtl(row.key, "ACTUAL_AMOUNT", clampNonNegative(e.target.value))} className="h-8 text-xs w-28" />
                            </td>
                            <td className="p-1">
